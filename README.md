...
###Compiling OpenCV
0. As a shortcut, if you intend to use the the exact same dependencies namely OpenCV 2.4.9, VS2012 and a Kepler GPU with CC3.0, you can just use my compilation. Unzip this [file](https://github.com/yeokm1/ssim-cuda/releases/download/v0.0/opencv249cuda.zip) to `C:\` and skip to step 12.
